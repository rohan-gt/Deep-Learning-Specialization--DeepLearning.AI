...
def generateTestCases():
    testCases = {
        "sentence_to_avg": {
            "partId": "Ub0em",
            "testCases": [
                {"testInput": ("I am going to the bar tonight", d), "testOutput": sta}
            ],
        },
        "model": {
            "partId": "EDw3y",
            "testCases": [{"testInput": (X, Y, d, 0.01, 300), "testOutput": (p, w, b)}],
        },
        "sentences_to_indices": {
            "partId": "ELQ6c",
            "testCases": [{"testInput": (X, dwi, 20), "testOutput": a}],
        },
        "pretrained_embedding_layer": {
            "partId": "pEJr9",
            "testCases": [{"testInput": (d, dwi), "testOutput": el}],
        },
        "Emojify_V2": {
            "partId": "VRhCD",
            "testCases": [{"testInput": (d, dwi), "testOutput": (cp, ml, mi, mo)}],
        },
    }
    return testCases
